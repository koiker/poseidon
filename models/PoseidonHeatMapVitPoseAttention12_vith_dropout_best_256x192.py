...
class Poseidon(nn.Module):
    def __init__(self, cfg, device='cpu', phase='train', num_heads=4, embed_dim=384):
        ...
        self.extract_layers = ExtractIntermediateLayers(self.model.backbone, self.return_layers)
    ...
    def forward(self, x, meta=None):
        ...
        x = x.view(batch_size, num_frames, self.embed_dim, 16, 12) # [batch_size, num_frames, 384, 24, 18]  ß
