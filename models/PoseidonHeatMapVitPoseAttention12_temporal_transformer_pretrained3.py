...
class Poseidon(nn.Module):
    def __init__(self, cfg, device='cpu', phase='train', num_heads=2, embed_dim=384, num_layers=1):
        ...
        pretrained_path = "/home/pace/Poseidon/results/2024-09-17/best_model.pt"
        ...
        # freeze deconv layers
        for param in self.deconv_layer.parameters():
            param.requires_grad = False
