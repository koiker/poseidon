...
class LearnablePositionalEncoding(nn.Module):
    ...
    def forward(self, x):
        ...
        return x + self.pos_embedding[:, :x.size(2), :].unsqueeze(1)  # Apply to the temporal dimension
...
class Poseidon(nn.Module):
    def __init__(self, cfg, device='cpu', phase='train', num_heads=8, embed_dim=384, num_layers=2):
