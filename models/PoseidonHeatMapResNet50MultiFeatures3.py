...
class Poseidon(nn.Module):
    ...
    def forward(self, x, meta=None):
        ...
        layer3 = self.adaptive_pool(layer3)  # shape: [batch_size*num_frames, 1024, 1, 1]
        layer4 = self.adaptive_pool(layer4)  # shape: [batch_size*num_frames, 2048, 1, 1]

        # concatenate layer3 and layer4
        backbone_outputs = torch.cat([layer3, layer4], dim=1)  # shape: [batch_size*num_frames, 3072, 1, 1]
