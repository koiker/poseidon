...
class Poseidon(nn.Module):
    def __init__(self, cfg, device='cpu', phase='train', num_heads=4, embed_dim_for_joint=30):
        ...
        self.device = device
        config_file = '/home/pace/Poseidon/models/resnet/td-hm_res152_8xb32-210e_coco-384x288.py'
        checkpoint_file = '/home/pace/Poseidon/models/resnet/td-hm_res152_8xb32-210e_coco-384x288-7fbb906f_20220927.pth'
