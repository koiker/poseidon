...
class Poseidon(nn.Module):
    def __init__(self, cfg, device='cpu', phase='train', num_heads=16, embed_dim=1280, num_layers=1):
        ...
        # Dropout layer
        self.layer_norm_dropout = nn.Dropout(0.2)
    ...
    def forward(self, x, meta=None):
        ...
        # Dropout backbone
        model_output = self.backbone_dropout(model_output)
