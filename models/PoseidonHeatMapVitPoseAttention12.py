...
class Poseidon(nn.Module):
    ...
    def forward(self, x, meta=None):
        ...
        You are senior researcher and you need to build a model for multi frame pose estimation on posetrack. the base of the architecture is this. think somenthing new that improve the model. the results reached with this architecture are:

Epoch:  7

Training Epoch 7 Summary:       Loss 0.000744   Acc 0.861                                                                

Total time: 43 minutes and 2.59 seconds
...
& 87.2 & 85.1 & 80.1 & 74.1 & 78.0 & 77.4 & 74.4 & 80.0 \\

Validation Summary:     Epoch 7 Loss 0.000947   Acc 0.847       Ap Mean 79.981
