...
class AdaptiveFrameWeighting(nn.Module):
    def __init__(self, embed_dim, num_frames):
        ...
        self.frame_quality_estimator = nn.Sequential(
            ...
            nn.Flatten(),
            nn.Linear(64, 1),
            nn.Dropout(0.2)  # Add dropout layer here
        )
...
class AttentionFusion(nn.Module):
    def __init__(self, embed_dim, num_heads):
        ...
        self.norm2 = nn.LayerNorm(embed_dim)  # Second layer norm after dropout
    ...
    def forward(self, features):
        ...
        features_cat = self.norm1(features_cat)
        
        # Apply self-attention
        attn_output, _ = self.attention(features_cat, features_cat, features_cat)
        
        # Add residual connection and second layer norm
        fused_features = self.norm2(features_cat + attn_output)
