...
def default_parse_args():
    ...
    parser.add_argument('--config', help='experiment configure file name', type=str, required=True)
    parser.add_argument('--PE_Name', type=str, default='Poseidon')
    ...
    args.cfg = osp.join(args.rootDir, osp.abspath(args.config))
